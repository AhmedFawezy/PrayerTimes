...
public class QiblaCompassView extends SquareImageView {
	...
	public void initCompassView() {
		...
		dashedPaint.setPathEffect(dashPath);
		dashedPaint.setColor(Color.parseColor("#FFFFFF"));
	...
	public void drawDial(Canvas canvas) {
		...
		circlePaint.setColor(Color.parseColor("#ff5A6131"));
...

	{
		...
		// draw
		moonPaintD.setColor(Color.BLACK);
	...
	public void setScreenResolution(int widthPixels, int heightPixels) {
		this.px = widthPixels / 4;
		this.py = heightPixels / 4;
	}
}
